...
@section('title', $post->title.' - Chỉnh sửa challenge')
@section('customcss')
                ...
                <div class="col-md-8 ps-1 pe-1">
                    <div class="card border-primary mb-2">
                        <div class="card-header bg-light">
                            <p class="m-0">
                                <a href="{{route('ql_baiviet.index')}}">Danh sách challenge</a> /
                                <a href="{{route('ql_baiviet.show', $post->id)}}">{{$post->title}}</a> /
                            </p>
                            <h3 class="inline">Chỉnh sửa challenge</h3>
                        </div>
                        <div class="card-body">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="title">Tên challenge</label>
                            ...
                            <div class="form-group">
                                <label class="form-check-label">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="status">Công khai challenge này</label>
                                    </div>
                            </div>
                        ...
                        <div class="modal-dialog mt-5 pt-5" role="document">
                            <div class="modal-content border-danger">
                                ...
                                <div class="modal-body">
                                    ...
                                    Tất cả <strong>Tài liệu</strong> nằm trong challenge
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" id="deleteBaiviet" name="delete" class="btn btn-danger"><i
                                            class="fa fa-trash pe-1"></i>Xóa challenge</button>
                                </div>
                            </div>
                        </div>
                    </div>
