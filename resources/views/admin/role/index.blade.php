                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary"
                                                    href="{{ route('ql_roles.edit', ['id'=>$role->id]) }}"><i
                                                        class="fa fa-edit me-2"></i>Chính sửa</a>
                                                <a class="btn btn-danger " data-mdb-toggle="modal"
                                                    data-mdb-target="#deleteModal"><i
                                                        class="fa fa-trash me-2"></i>Xóa</a>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
            ...
            <div class="modal-dialog mt-5 pt-5">
                <div class="modal-content">
                    ...
                    <div class="modal-body">Hành động XÓA này sẽ không thể hoàn tác!<br>
                        Tất cả <strong>challenge</strong> và <strong>Danh mục con</strong> nằm
                        trong
                        danh mục
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" data-dismiss="modal"><i
                                class="fa fa-times me-2"></i>Hủy</button>
