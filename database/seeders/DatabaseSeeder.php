...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //   create acc
        $userTeacher= User::create(['name' => 'teacher', 'email' => 'teacher@gmail.com', 'password' => bcrypt('teacher'), 'created_at' => NOW()]);
        $userStudent= User::create(['name' => 'student',  'email' => 'student@gmail.com', 'password' => bcrypt('student'), 'created_at' => NOW()]);
